...
import br.com.danaraujo.converter.custom.PersonConverter;
...
public class PersonServices {
	...
	public PersonVOTempVersion createTempVersion(PersonVOTempVersion person) {
		
		var entity = converte.convertVoToEntity(person);
		var vo = converte.convertEntityToVo(repository.save(entity));
