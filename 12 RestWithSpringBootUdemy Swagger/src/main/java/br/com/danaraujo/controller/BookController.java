...
import br.com.danaraujo.data.vo.BookVO;
import br.com.danaraujo.services.BookServices;
import io.swagger.annotations.Api;
import io.swagger.annotations.ApiOperation;

@Api(value = "Book Endpoint", description = "Book Endpoint", tags = {"BookEndpoint"})
@RestController
...
public class BookController {
	...
	@ApiOperation(value = "Find a book by record")
